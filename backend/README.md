...
## Project Structure
    ...
    ├── testapiautoconnect_114344  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_114344`
...
2. Clone this repo and `cd testapiautoconnect_114344`
